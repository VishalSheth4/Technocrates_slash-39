...
$(document).ready(function() {
	...
	overlayMap.drawOverlay({
		...
		content: '<div class="popover top" style="display:block; width:200px"><div class="arrow"></div><div class="popover-content"><strong>You are here</strong><p>Munich,Germany</p></div></div>',
		verticalAlign: 'top',
